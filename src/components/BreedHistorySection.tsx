      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center">
            ...
            <Tabs defaultValue="historia" className="w-full mt-8">
              <TabsList className="grid w-full grid-cols-4 mb-8">
                <TabsTrigger 
                  value="historia"
                  className="text-sm sm:text-base data-[state=active]:bg-accent data-[state=active]:text-accent-foreground"
              ...
              <TabsContent value="historia" className="space-y-6 text-left">
              ...
              <TabsContent value="genetica" className="space-y-6 text-left">
                <div className="bg-background p-6 rounded-xl shadow-lg transform transition-all duration-300 hover:shadow-xl">
              ...
              <TabsContent value="pelaje" className="space-y-6 text-left">
                <div className="bg-background p-6 rounded-xl shadow-lg transform transition-all duration-300 hover:shadow-xl">
              ...
              <TabsContent value="caracteristicas" className="space-y-6 text-left">
                <div className="bg-background p-6 rounded-xl shadow-lg transform transition-all duration-300 hover:shadow-xl">
